...
const MantisWallet = () => {
  ...
  const connection = useMemo(
    ...
    [] // Dependencies: only create connection once
  );

  const calculateAndSetTokenValues =  useCallback(async () => {
  ...
  }, [isConnected, address, walletInfo?.name, calculateAndSetTokenValues]);
            ...
            <>
              ...
              <div className="flex flex-col w-full gap-1 items-center">
                ...
                {walletInfo?.name === "MetaMask" && (
                  <p className="text-white/dark px-4">
                    Connect your phantom wallet to see your assets.
                  </p>
                )}
              </div>
            </>
